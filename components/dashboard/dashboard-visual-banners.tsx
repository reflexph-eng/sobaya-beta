...
export function DashboardVisualBanners() {
  return (
    <section className="sticky top-0 z-10 -mx-1 bg-white/95 py-2 backdrop-blur supports-[backdrop-filter]:bg-white/80 md:top-0" aria-label="Bannière SOBAYA">
      <div className="overflow-hidden rounded-2xl border border-sobaya-border bg-white shadow-sm">
        <img
          ...
          className="h-[118px] w-full object-cover sm:h-[132px] lg:h-[148px]"
          loading="eager"
        />
      </div>
    </section>
